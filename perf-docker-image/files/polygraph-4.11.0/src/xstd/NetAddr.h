...
class NetAddr {
	public:
		...
		/* using theAddrA w/o syncA() is OK here -- none of these can be IPs */
		bool isWildcard() const { return theAddrA && *theAddrA == '*'; }
		bool isDynamicName() const { return theAddrA && *theAddrA == '.'; }
