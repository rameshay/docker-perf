...
class DnsMgr: protected Dns, public FileScanUser {
	public:
		...
		typedef enum { dnsAlreadyAnIp, dnsCacheHit, dnsZoneHit, dnsNeedsAsyncLookup } InstantLookupResult;
	...
	protected:
		...
		DnsCache *theCache; // optional "dynamic" lookup cache

		// TODO: Replace this optional, "large" field with a pointer.
		AddrMap thePreloadedAddresses; // optional "static" lookup cache
