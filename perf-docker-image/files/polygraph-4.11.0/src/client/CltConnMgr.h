...
class CltConnMgr: public ConnMgr {
	...
	protected:
		Connection *open(const NetAddr &hopAddr, const NetAddr &tcpHopAddr, ProtoIntvlPtr protoStat, const NetAddr &tunnelAddr, const NetAddr &destAddr, bool needsSsl, bool needsSslProxy, const NetAddr &proxy);
	...
	protected:
		...
		bool supportsSni; // whether to send TLS SNI extension when possible
};
