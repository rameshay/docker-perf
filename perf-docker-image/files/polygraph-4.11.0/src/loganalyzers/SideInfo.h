...
class SideInfo: public SomeInfo {
	...
	protected:
		...
		void cmplProtoConnLevelTable(BlobDb &db, const PhaseInfo &phase, const Scope &scope);
		void cmplProtoConnLevelFigure(BlobDb &db, ReportBlob &blob, const Scope &scope);
